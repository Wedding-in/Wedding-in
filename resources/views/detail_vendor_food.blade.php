            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Food/Food1.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
                        <h6>Rp. 150,000 - 500,000</h6>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Food/Food2.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
                ...
                <div class="carousel-item">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Food/Food3.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
        ...
        <div class="container">
            <div class="d-flex flex-row" style="">
                <div class="text-vendor-left d-flex mt-4 bookmark-hover" style=" width: 70%; ">
                    <h4 style="  margin-right: 10px; height: min-content">Garuda Mutiara Katering</h4>
                ...
                <div class="rate d-flex justify-content-end mt-4" style=" width: 50%">
                    ...
                    <span class="text-black" style="color: #FCB2A9; font-family: SourceSerif4-Light">4.8</span>
            ...
            <div class="d-flex flex-row gap-1">
                ...
                <h6 class="mt-1" style="font-family: SourceSerif4-Medium">Jl. Kalibata Timur Raya No.57 14,
                    RT.14/RW.1, Pejaten Timur, Ps. Minggu, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12510
                </h6>
            ...
            <h6 class="container mt-1">
                Mutiara Garuda Catering adalah penyedia layanan makanan premium yang mengutamakan kebersihan, kerapihan,
                serta kepuasan client. Kami menyediakan berbagai pilihan menu, mulai dari masakan tradisional Indonesia
                hingga masakan internasional, yang dapat disesuaikan dengan selera dan kebutuhan acara Anda.
            </h6>
            ...
            <div class="row row-cols-2 mt-1">
                <div class="col mt-2">
                    <a href="/Detail_Product_Food">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Food/Food1.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">American Buffet</h5>
                                <p class="overflow-ellipsis">
                                    Memperkenalkan Prasmanan khas Amerika kami. Kaya rasa dan menu, pasti Anda akan
                                    ketagihan lagi
                                </p>

                                <a class="Read_more" href="/Detail_Product_Food">Read more</a>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col mt-2">
                    <a href="/Detail_Product_Food">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Food/Food2.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Indonesian Buffet</h5>
                                <p class="overflow-ellipsis">
                                    Memperkenalkan Prasmanan khas Indonesia kami. Kaya rasa dan menu, pasti Anda akan
                                    ketagihan lagi
                                </p>
                ...
                <div class="col mt-2">
                    <a href="/Detail_Product_Food">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Food/Food3.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Japanesse Buffet</h5>
                                <p class="overflow-ellipsis">
                                    Memperkenalkan Prasmanan khas Jepang kami. Kaya rasa dan menu, pasti Anda akan
                                    ketagihan
                                    lagi
                                </p>
                ...
                <div class="col mt-2">
                    <a href="/Detail_Product_Food">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Food/Food4.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Italian Buffet</h5>
                                <p class="overflow-ellipsis">
                                    Memperkenalkan Prasmanan khas Italia kami. Kaya rasa dan menu, pasti Anda akan
                                    ketagihan
                                    lagi
                                </p>
            ...
            <div class="review-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Kami sangat puas dengan layanan dari Garuda Mutiara Catering. Mereka tidak hanya menyediakan
                            makanan yang enak, tetapi juga memastikan semuanya disajikan dengan sangat rapi dan bersih
                        </h6>
                    </div>
                </div>
            </div>
            <div class="review-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Layanan catering dari Garuda Mutiara benar-benar top-notch! Setiap hidangan memiliki cita
                            rasa yang istimewa dan tim mereka sangat responsif serta ramah</h6>
                    </div>
                </div>
            </div>
            <div class="review-card mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Garuda Mutiara Catering benar-benar luar biasa! Hidangannya lezat, penyajiannya elegan, dan
                            seluruh tim sangat profesional. Semua tamu kami sangat terkesan.</h6>
                    </div>
                </div>
            </div>
        </div>
