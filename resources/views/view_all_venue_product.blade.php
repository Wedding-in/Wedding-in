...
<body>
    <div class="container">
        <div class="container panah" style="height: 55px; display: flex; flex-direction: column; justify-content: center">
            <a style="text-decoration: none; color: black" href="/Detail_Vendor_Venue"><i class="bi bi-arrow-left-short" style="font-size: 40px; margin-left: -3%"></i></a>
        </div>
        <div class="container">
            ...
            <div class="row row-cols-2 mt-1">
                ...
                <div class="col mt-2">
                    <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                        <div style="height: 180px">
                            <img src="/Image/Detail_Vendor_Venue/Product5.jpeg"
                                class="card-img-top" style="width: 100%; height: 100%;" alt="...">
                        </div>
                        <div class="card-body">
                            ...
                            <p class="overflow-ellipsis">
                                ...
                                12. Ruang serbaguna untuk rapat koordinasi pernikahan yang dapat digunakan oleh 12 orang
