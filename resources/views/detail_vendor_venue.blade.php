            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Venue/Venue1.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
                        <h6>Rp. 100,000,000 - 700,000,000</h6>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Venue/Venue2.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
                ...
                <div class="carousel-item">
                    <div class="Carousel_image">
                        <img src="/Image/Detail_Vendor_Venue/Venue3.jpeg" class="d-block w-100" alt=""
                            style="height: 100%; width: 100%; border-radius: 10px">
                    </div>
                    <div class="container_price"></div>
                    <div class="price_text ms-3">
        ...
        <div class="container">
            <div class="d-flex flex-row" style="">
                <div class="text-vendor-left d-flex mt-4 bookmark-hover" style=" width: 70%; ">
                    <h4 style="  margin-right: 10px; height: min-content">Indonesia Convention Exhibition (ICE)</h4>
            ...
            <div class="d-flex flex-row gap-1">
                ...
                <h6 class="mt-1" style="font-family: SourceSerif4-Medium">Jl. BSD Grand Boulevard No.1, Pagedangan,
                    Kec. Pagedangan, Kabupaten Tangerang, Banten 15339</h6>
            ...
            <h6 class="container mt-1">
                Indonesia Convention Exhibition adalah sebuah pusat konvensi dan pameran terbesar di Indonesia. ICE juga
                dikenal sebagai gedung konser dan gedung pernikahan terbesar dan berlokasi di Kompleks Bumi Serpong
                Damai
            </h6>
            ...
            <div class="row row-cols-2 mt-1">
                <div class="col mt-2">
                    <a href="/Detail_Product_Venue">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Venue/Product1.jpeg" class="card-img-top"
                            ...
                            <div class="card-body">
                                ...
                                <a class="Read_more" href="/Detail_Product_Venue">Read more</a>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col mt-2">
                    <a href="/Detail_Product_Venue">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Venue/Product2.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                ...
                                <p class="overflow-ellipsis">
                                    ...
                                    AKOMODASI
                                    1. Menginap satu malam di Premier Bridal Suite pada hari acara di Hotel Santika
                                    Premiere
                                    ICE BSD termasuk sarapan pagi untuk pasangan
                                    2. Menginap Satu Malam di 2 Kamar Deluxe untuk orang tua pada hari acara di Hotel
                                    Santika Premiere ICE BSD termasuk sarapan untuk dua orang
                ...
                <div class="col mt-2">
                    <a href="/Detail_Product_Venue">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Venue/Product3.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                ...
                                <p class="overflow-ellipsis">
                                    ...
                                    5. Air mancur kaca sampanye dengan dua botol sari buah apel berkilau untuk upacara
                                    bersulang
                                    6. Air es gratis selama acara
                                    7. Rangkaian bunga untuk meja prasmanan
                                    8. Penggunaan ruangan maksimal 8 jam
                                    ...
                                    AKOMODASI
                                    1. Menginap dua malam di Premiere Bridal Suite pada hari acara di Hotel Santika
                                    Premiere
                                    ICE BSD termasuk sarapan pagi untuk pasangan
                                    2. Menginap dua malam di 2 Kamar Deluxe untuk orang tua pada hari acara di Hotel
                                    Santika
                                    Premiere ICE BSD termasuk sarapan untuk dua orang
                                    3. Menginap satu malam di 4 Kamar Deluxe untuk Keluarga pada hari acara di Hotel
                                    Santika
                                    Premiere ICE BSD termasuk sarapan untuk dua orang
                ...
                <div class="col mt-2">
                    <a href="/Detail_Product_Venue">
                        <div class="card" style="width: 100%; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);">
                            <div style="height: 180px">
                                <img src="/Image/Detail_Vendor_Venue/Product4.jpeg" class="card-img-top"
                                    style="width: 100%; height: 100%;" alt="...">
                            </div>
                            <div class="card-body">
                                ...
                                <p class="overflow-ellipsis">
                                    ...
                                    HARI PERNIKAHAN
                                    1. Pengaturan khusus 550 porsi Pilihan Menu Prasmanan Pernikahan Internasional
                                    Premium
                                    2. 400 gelas softdrink atau es teh rasa
                                    3. 30 porsi makan malam awal keluarga
                                    4. Ruang serbaguna untuk ruang ganti keluarga atau panitia
                                    ...
                                    AKOMODASI
                                    1. Menginap dua malam di premier Bridal Suite pada hari acara di Hotel Santika
                                    Premiere
                                    ICE BSD termasuk sarapan untuk pasangan
                                    2. Menginap dua malam di 2 Kamar Deluxe untuk orang tua pada hari acara di Hotel
                                    Santika
                                    Premiere ICE BSD termasuk sarapan untuk dua orang
                                    3. Menginap satu malam di 4 Kamar Deluxe untuk keluarga pada hari acara di Hotel
            ...
            <div class="review-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Venue pernikahan di sini benar-benar memukau! Tempatnya indah dan sangat cocok untuk
                            pernikahan impian kami. Semua tamu juga sangat terkesan dengan keindahan tempat ini</h6>
                    </div>
                </div>
            </div>
            <div class="review-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Tidak ada yang bisa mengalahkan keindahan dan kenyamanan venue di sini. Setiap sudut tempat
                            ini begitu menawan dan membuat momen pernikahan kami semakin berkesan. Sangat
                            direkomendasikan!</h6>
                    </div>
                </div>
            </div>
            <div class="review-card mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <h6>Kami sangat senang memilih venue ini sebagai lokasi pernikahan kami. Tempatnya luas, bersih,
                            dan memiliki pemandangan yang menakjubkan. Pelayanan stafnya juga sangat ramah dan membantu
                        </h6>
                    </div>
                </div>
            </div>
